"""Napisati funkciju koja na osnovu zadatog težinskog neusmerenog grafa i dva zadata (ciljna) čvora 
G1 i G2 formira težinski graf sa heuristikom. Heuristika proizvoljnog čvora C se određuje kao 
dužina puta od čvora C do bližeg od čvorova G1 i G2. Dozvoljeno je najviše dva puta pozvati 
prilagođeni algoritam obilaska grafa."""
...
print(weighted_graph_with_dual_heuristic(graph, 'D', 'F'))
