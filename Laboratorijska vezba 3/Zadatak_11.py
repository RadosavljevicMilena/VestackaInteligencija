"""Napisati funkciju koja određuje čvorove koje je moguće izbaciti iz neusmerenog grafa tako da graf 
i dalje ostane povezan."""
...
def removable_edges(graph):
    ...
    for node in graph:
        for neighbor in graph[node]:
            ...
            visited_after_removal = dfs(graph, node, edge)  # Novi naziv za set koji prima rezultat DFS-a
...
# Očekivani rezultat: Sve grane osim mostova, npr. [('A', 'B'), ('A', 'C'), ('B', 'E'), ('C', 'F'), ('E', 'F')]